...
相关资料：[检索概述](/ai/video/video_retrieval/30/survey) · [图像检索资源](/ai/cv/retrieval/22/foundation) · [音频检索资源](/ai/audio/audio_retrieval/foundation)    
...
# 3 技术点
## 3.1 [关键帧提取](/ai/video/key_frame/foundation)
...
**3.2.1 [帧特征](/ai/cv/retrieval/22/foundation#31-特征提取)**     
...
**3.4.4 图对齐**     
>[最大流](/ai/algorithms/graph/20/maximum-flow)      
...
## 3.5 相似度度量
>[序列相似度度量](/ai/data_mining/sequence_alignment/foundation)、[字符串匹配](/software/algorithms/string/29/pattern-match-foundation)
...
### 4.5.2 图片
#### 4.5.2.1 [行人重识别](/ai/cv/human/human_reid/foundation#352-视频)    
#### 4.5.2.2 商品检索
...
### 4.5.3 [文本](/ai/video/video_caption/23/foundation#4-零样本检索)
