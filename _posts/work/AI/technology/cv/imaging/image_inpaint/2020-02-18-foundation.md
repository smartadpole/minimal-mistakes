...
title:  "「CV」 图像修复资源汇总"
mathjax: true
key: image-inpaint-foundation
toc: true
toc_sticky: true
category: [AI, CV, image_inpaint]
tags: 资源
---
<span id='head'></span>  
>修补图像中少量的缺失；    
...
# 2 图像修复
1. [Unsupervised Representation Learning with Deep Convolutional Generative Adversarial Networks](/ai/dl/gan/26/foundation#DCGAN)    
...
# 3 应用
## 3.1 [人脸](/ai/cv/human/facial_inpaint/foundation)
