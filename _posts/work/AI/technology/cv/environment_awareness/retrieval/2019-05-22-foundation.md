...
---
<span id='head'></span>  
>相关资料：[图片检索概述](/ai/cv/retrieval/20/survey)、[视频检索资源](/ai/video/video_retrieval/21/foundation) · [音频检索资源](/ai/audio/audio_retrieval/foundation)      
...
**3.1.2 [DL](/ai/dl/cnn/21/foundation)**
...
$\bullet \bullet$   
**DELF**，同时发布了较大的[地标建筑检索数据集](https:/www.kaggle.com/google/google-landmarks-dataset#test.csv)([详细说明](/ai/competition/25/Google-Landmark-Retrieval-29))；   
...
CVPR 26 DeepVision *26-04-29* [paper](https:/arxiv.org/abs/1604.08893) | [project](http:/imatge-upc.github.io/retrieval-26-deepvision/) | [tensorflow](https:/github.com/imatge-upc/retrieval-26-deepvision) | [解读](/ai/cv/retrieval/paper_reading/28/Faster-RCNN-Features-for-Instance-Search-Reading)     
$\bullet \bullet$    
instance   
...
### 4.3.1 [行人](/ai/cv/human/human_reid/foundation)

### 4.3.2 [车辆](/ai/cv/vehicle/vehicle_reid/foundation)
