...
*29-07-11* [paper](https:/arxiv.org/abs/1907.09408) | [阅读](/ai/cv/detection/paper_reading/A-Survey-of-Deep-Learning-based-Object-Detection) | [blog](https:/zhuanlan.zhihu.com/p/80751176)-Merria28       
...
[训练](/ai/dl/foundation/20/foundation#322-检测)
...
# 5 应用
[人](/ai/cv/human/human_detection/foundation)、[文本](/ai/cv/ocr/27/foundation#4-文本检测) 、交通（[车道线](/ai/cv/traffic/traffic_semantic_analysis/20/foundation)、[交通标志](/ai/cv/traffic/traffic_signals_recognition/foundation)、[车辆](/ai/cv/vehicle/vehicle_detect/foundation)、船体、[安全带](/ai/cv/traffic/driver_analysis/foundation#5-安全带识别)）、商品（Logo、商品）、医疗（肺结节）、[视频](/ai/video/video_detection/22/foundation) 、航拍、自然（[云层](/ai/cv/nature/sky/foundation#31-检测)）、动物、[水下目标检测](/ai/cv/nature/underwater_image/25/foudnation#4-目标检测)    
