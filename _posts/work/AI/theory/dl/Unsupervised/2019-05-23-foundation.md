...
# 1 综述
1. [A survey on Semi-, Self- and Unsupervised Techniques in Image Classification](/ai/cv/classification/foundation#unsupervised)    
*2020-02-20*    
...
# 5 应用
## 5.1 视觉异常检测
>[异常检测](/ai/data_mining/anomaly_detect/foundation)   
...
ECCV 28 *28-07-15* [paper](https:/arxiv.org/abs/1807.05520) | [解读](/ai/cv/unsupervised/paper_reading/Deep-Clustering-for-Unsupervised-Learning-of-Visual-Features)    
