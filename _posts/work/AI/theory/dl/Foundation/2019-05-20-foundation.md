...
#### 2.1.5 形变卷积
1. [Deformable Convolutional Networks](/ai/cv/detection/foundation#3deformable)    
...
1. [Perturbed Model Validation: A New Framework to Valilast_modified_at Model Relevance](https://arxiv.org/abs/1905.10201)     
